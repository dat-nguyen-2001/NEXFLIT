  ...
  return (
    <div className="text-white text-sm font-semibold md:text-base lg:text-xl">
      ...
      <div className="flex group relative">
        {scrolling ? (
          <div className='absolute left-0 rounded-r-sm h-[100%] flex flex-col items-center m-auto w-12 top-0 bottom-0 cursor-pointer z-50 bg-black/50 hover:bg-black/70'
